...
public class Din extends AppCompatActivity {

    Button backb;
    ToggleButton ledb,lampb,fannb;
    String address = null;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        address="00:21:13:01:25:9C";//"98:D3:32:70:D8:17";
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void>  // UI thread
    {
        ...
        {
            progress = ProgressDialog.show(Din.this, "Connecting", "Please wait");  //show a progress dialog
        }
